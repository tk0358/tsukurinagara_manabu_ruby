...
yomies = %w(やまだまさき おおばしんいちろう)
publishers = %w(ソフトリサーチセンター ソフトバンククリエイティブ)
pages = [248, 164,]
prices = [2500, 2400,]
purchase_prices = [2650, 2520,]

isbn_10s = %w(4883732088 4797338253)
isbn_13s = %w(978-4883732081 978-4797338256)
